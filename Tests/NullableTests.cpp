...
TEST(NullableUtilities, AsSpan)
{
    Nullable<int32> nullableA;
    Nullable<Index> nullableB;
    GTEST_ASSERT_EQ(AsSpan(nullableA).Count(), 0);
    GTEST_ASSERT_EQ(AsSpan(nullableB).Count(), 0);
    nullableA.Set(69);
    nullableB.Set({ 69 });
    GTEST_ASSERT_EQ(AsSpan(nullableA).Count(), 1);
    GTEST_ASSERT_EQ(AsSpan(nullableB).Count(), 1);
    GTEST_ASSERT_EQ(AsSpan(nullableA)[0], 69);
    GTEST_ASSERT_EQ(AsSpan(nullableB)[0], 69);
}
